...
struct CastleCommsApp: App {
    ...
    func setupNotifications() {
        Messaging.messaging().delegate = MessagingDelegate.shared
...
struct MainView: View {
    ...
    func showToken() {
        let alert = UIAlertController(title: "FCM Token", message: fcmToken, preferredStyle: .alert)
...
class MessagingDelegate: NSObject, ObservableObject {
...
extension MessagingDelegate: MessagingDelegate {
